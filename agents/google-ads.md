---
name: google-ads
description: "Pushes approved campaign assets to Google Ads via Composio. For: ads."
tools: "Read, Grep, Glob, Bash, Write, WebFetch, WebSearch"
model: sonnet
color: orange
---
<!-- GENERATED by .claude/scripts/one-agents.mjs from one.ie/ai/agents/ads-google/agent.md — do not hand-edit.
...
<chips>[{"id":"check-google-status","label":"Check Google Ads status"},{"id":"pause-google","label":"Pause Google ads"}]</chips>
