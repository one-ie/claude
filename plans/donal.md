...
[vars]
EMBED_MODE = "true"       # serves /v1/embed.js + proxies chat to app.one.ie
...
| Existing Stripe integration | [`../one.ie/web/src/pages/api/pay/create-intent.ts`](../one.ie/web/src/pages/api/pay/create-intent.ts) |
