...
Visit [app.one.ie/get-yours](https://app.one.ie/get-yours), enter your name (optional), accept the terms, and click **Create your space**. Your device will prompt for Face ID or Touch ID. No password, no account — your passkey is the key.
