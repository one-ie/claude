...
- [`.claude/rules/design.md`](../.claude/rules/design.md) — 6 tokens, no palette colors
- [`web/src/pages/api/chat.ts`](../one.ie/web/src/pages/api/chat.ts) — main edit surface
- [`web/src/components/Chat.tsx`](../one.ie/web/src/components/Chat.tsx) — client edit surface
