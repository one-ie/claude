...
10 stages in [lifecycle.md](lifecycle.md); each stage has a security
...
- [auth.md](apps/ants/docs/auth.md) — Identity, keys, wallets
- [groups.md](groups.md) — RBAC, ABAC, ReBAC, tenancy
