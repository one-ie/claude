...
```
- [x] R1 — recon · findings verbatim in W1 report
- [x] D1 — decide · 3 design decisions resolved (async builder, KV-prefix loadSkillTools, slug userId)
- [x] E1 — bun add @composio/core @composio/vercel OK
- [x] E2 — composio.ts · tsc clean
- [x] E3 — composio-toolkits.ts · tsc clean
- [x] E4 — skill-tools.ts · tsc clean
- [x] E5 — connect.ts + env.d.ts · tsc clean
- [x] E6 — callback.ts · tsc clean
- [x] S1 — builder.ts + types.ts + wrangler.toml + index.ts wired · skill-first routing confirmed · tsc clean
- [x] V1 — tsc clean (both) · checklist 6/6 · rubric 0.79 ≥ 0.65
```
...
- [`one/template-todo.md`](template-todo.md) — TODO shape
- [`one/rubrics.md`](rubrics.md) — scoring contract
- [`one/patterns.md`](patterns.md) — closed loop, Rule 1
