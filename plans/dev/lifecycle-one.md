...
Substrate-view sibling doc (agent's graph tenure): [lifecycle.md](lifecycle.md).
...
**What happens:**
1. Invite signal sent → `app.one.ie/join?ref=alice`
...
- [templates/web](../templates/web/) — app.one.ie template implementing this funnel
