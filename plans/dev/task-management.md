...
```typeql
insert $u isa actor, has aid "scout-1",
...
- [claude-code-integration.md](../plans/claude-code-integration.md) -- Claude Code as a substrate agent
- [loops.md](../plans/loops.md) -- The seven nested feedback loops
