...
> See: [people.md](agents.md) for anatomy, [ants.md](ants.md) for biological grounding
...
4. **[people.md](agents.md)** — What a unit is. Tasks, continuations, roles.
...
- [people.md](agents.md) — Unit anatomy and tasks
